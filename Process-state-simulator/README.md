...
Contributions are welcome, especially for educational improvements.

1. Create a branch.

```bash
git checkout -b feature/improve-scheduler-ui
```

2. Keep changes focused and documented.
3. Test the simulator manually with at least one full lifecycle and one context-switch scenario.
